...
namespace DungeonCrawler
{
    public static class HeroInteraction
    {
        ...
        public static void Win(Hero hero, int experienceUp)
        {
            ...
            if (ConsoleHelper.ConfirmAction($"Želite li utrošiti {hero.Experience / 2} XP za obnovu zdravlja? [XP: {hero.Experience}, Zdravlje: {hero.Health}/{hero.HealthPoints}]"))
                if (hero.WinCheckLevelUp(true))
